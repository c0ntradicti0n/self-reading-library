...
function getOverlayMiddleware(options) {
                ...
                switch (_e.label) {
                    ...
                    case 2:
                        try {
                            ...
                            m = (_c = compilation === null || compilation === void 0 ? void 0 : compilation.modules) === null || _c === void 0 ? void 0 : _c.find(function (m) { return m.id === id; });
                            return [2 /*return*/, ((_d = m === null || m === void 0 ? void 0 : m.source(compilation.dependencyTemplates, compilation.runtimeTemplate)) !== null && _d !== void 0 ? _d : null)];
                        }
                        catch (err) {
    ...
    return function (req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _p, pathname, query, frame, isServerSide, moduleId, source, err_1, frameLine, frameColumn, pos, consumer, err_2, filePath, fileContent, originalFrame, originalCodeFrame, o, frame, frameFile, filePath, fileExists, frameLine, frameColumn, err_3;
