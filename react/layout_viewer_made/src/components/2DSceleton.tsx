...
let zoom = d3.zoom()  .on('zoom', handleZoom);
  ...
  node.append("circle")
      .attr("fill", (d, n) => d.children ? `#${(n+3) % 9}${(n+4) %10}${(n+5) %11}` : fill)
...
export default function BubbleGraph({height=1000, width= 1000}) {
  ...
  return (
    ...
    <div id="treeWrapper" style={{ width: '100%', height: '94%', overflow: "hidden" }}>
