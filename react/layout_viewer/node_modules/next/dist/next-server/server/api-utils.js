 ...
 * @param req request object
 */function getCookieParser(req){return function parseCookie(){const header=req.headers.cookie;if(!header){return{};}const{parse}=require('next/dist/compiled/cookie');return parse(Array.isArray(header)?header.join(';'):header);};}/**
 *
