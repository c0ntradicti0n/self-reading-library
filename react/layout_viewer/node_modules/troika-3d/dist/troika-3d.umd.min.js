...
a.forEach(function(a){var d=v[a],g=e[a];if(d||g){var l=new RegExp("\\b"+a+"\\b","g");h.push("attribute "+(d||g)+" troika_"+a+";");d&&(c=c.replace(l,F));g&&(b=b.replace(l,Ea),d="varying "+g+" troika_vary_"+a+";",h.push(d),f.push(d),C.push("troika_vary_"+a+" = troika_"+a+";"))}});c="\n"+h.join("\n")+"\n"+c.replace(y.voidMainRegExp,"\n  $&\n  "+C.join("\n")+"\n");f.length&&(b="\n"+f.join("\n")+"\n"+b);return{vertexShader:c,fragmentShader:b}}function da(c,b,a){var d=c.itemSize;1===d?c.setX(b,a):2===d?
c.setXY(b,a.x,a.y):3===d?a.isColor?c.setXYZ(b,a.r,a.g,a.b):c.setXYZ(b,a.x,a.y,a.z):4===d&&c.setXYZW(b,a.x,a.y,a.z,a.w)}function ea(c,b){var a=c.uniforms;return a&&a[b]?a[b].value:(a=y.getShadersForMaterial(c).uniforms)&&a[b]?a[b].value:null}function K(c){return c[c.hasOwnProperty("instanceCount")?"instanceCount":"maxInstancedCount"]}function fa(c,b){c[c.hasOwnProperty("instanceCount")?"instanceCount":"maxInstancedCount"]=b}u=u&&Object.prototype.hasOwnProperty.call(u,"default")?u["default"]:u;m=m&&
Object.prototype.hasOwnProperty.call(m,"default")?m["default"]:m;var L=k.utils.assign,ha=k.utils.forOwn,ia=new e.Vector3,Fa=new e.Vector3,t=function(){var c={callback:function(b){c.value=b},value:null};return c}(),Ga={type:"removed"},D=[],Ha=0,Ia=0,n=function(c){function b(a,d){c.call(this,a);d.matrixAutoUpdate=!1;this.threeObject=d;d.$facade=this;var b=!1!==d.isRenderable;b||(d.layers.mask=0);for(;a;){if(a.isObject3DFacade){this._parentObject3DFacade=a;b&&this._addToThreeObjectTree();break}a=a.parent}this.notifyWorld("object3DAdded")}
c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;b.prototype.afterUpdate=function(){this.updateMatrices();this._checkBoundsChange();this._worldMatrixVersion>this._worldMatrixVersionAfterLastUpdate&&(this.shouldUpdateChildren()||this.traverse(function(a,d){a!==d&&a.updateMatrices&&(a.updateMatrices(),a._checkBoundsChange())},this),this._worldMatrixVersionAfterLastUpdate=this._worldMatrixVersion);c.prototype.afterUpdate.call(this);if(this._removeChildIds){var a=
this.threeObject,d=this._removeChildIds;a.children=a.children.filter(function(a){return a.id in d?(a.parent=null,a.dispatchEvent(Ga),!1):!0});var b=this._parentObject3DFacade;S(a)&&b&&b.threeObject===a.parent&&b._queueRemoveChildObject3D(a.id);this._removeChildIds=null}};b.prototype.updateMatrices=function(){var a=this.threeObject,d=this._parentObject3DFacade;if(this._matrixChanged){a.matrix.compose(a.position,a.quaternion,a.scale);this._matrixChanged=!1;var b=!0}else b=d&&d._worldMatrixVersion>this._worldMatrixVersion;
if(b){d?a.matrixWorld.multiplyMatrices(d.threeObject.matrixWorld,a.matrix):a.matrixWorld.copy(a.matrix);a=a.children;d=0;for(b=a.length;d<b;d++)a[d].$facade||a[d].updateMatrixWorld(!0);this.markWorldMatrixDirty()}};b.prototype.markWorldMatrixDirty=function(){this._worldMatrixVersion=++Ha;this._boundsChanged=!0};b.prototype._checkBoundsChange=function(){var a=this._boundsChanged;if(!a){var d=this._getGeometryBoundingSphere();d&&d.version!==this._lastGeometrySphereVersion&&(a=!0,this._lastGeometrySphereVersion=
d.version)}a&&(this.notifyWorld("object3DBoundsChanged"),this._boundsChanged=!1)};b.prototype.getWorldPosition=function(a){this.updateMatrices();return(a||new e.Vector3).setFromMatrixPosition(this.threeObject.matrixWorld)};b.prototype.getCameraPosition=function(a){a=a||new e.Vector3;this.notifyWorld("getCameraPosition",a);return a};b.prototype.getCameraFacade=function(){t.value=null;this.notifyWorld("getCameraFacade",t);return t.value};b.prototype.getCameraDistance=function(){var a=this.getCameraPosition(Fa),
d=this.getWorldPosition(ia);return a.distanceTo(d)};b.prototype.getProjectedPosition=function(a,d,b){this.updateMatrices();t.value=null;t.worldPosition=ia.set(a||0,d||0,b||0).applyMatrix4(this.threeObject.matrixWorld);this.notifyWorld("projectWorldPosition",t);return t.value};b.prototype.getSceneFacade=function(){t.value=null;this.notifyWorld("getSceneFacade",t);return t.value};b.prototype.getBoundingSphere=function(){var a=this._getGeometryBoundingSphere();if(!a)return null;this.updateMatrices();
var d=this._boundingSphere;d||(d=this._boundingSphere=new e.Sphere);if(d._geometrySphereVersion!==a.version||d._worldMatrixVersion!==this._worldMatrixVersion)d.copy(a),d.applyMatrix4(this.threeObject.matrixWorld),d._worldMatrixVersion=this._worldMatrixVersion,d._geometrySphereVersion=a.version;return d};b.prototype._getGeometryBoundingSphere=function(){var a=this.getGeometry();if(a){var d=a.boundingSphere,b=!1;if(d)if(a.isBufferGeometry){var c=a.attributes.position;c&&d._posAttrVersion!==c.version&&
(a.computeBoundingSphere(),d._posAttrVersion=c.version,b=!0)}else a._lastBoundingSphere&&d.equals(a._lastBoundingSphere)||(a._lastBoundingSphere=d.clone(),b=!0);else a.computeBoundingSphere(),d=a.boundingSphere,b=!0;b&&(d.version=++Ia);return d}return null};b.prototype.getGeometry=function(){var a=this.threeObject;return a&&a.geometry};b.prototype.raycast=function(a){return this.threeObject?this._raycastObject(this.threeObject,a):null};b.prototype._raycastObject=function(a,d){if(a.visible){D.length=
0;var b=null,c=this.raycastSide;null!=c&&(b=a.material.side,a.material.side=c);a.raycast(d,D);null!==b&&(a.material.side=b);if(D.length)return D.sort(xa),D.slice()}return null};b.prototype._addToThreeObjectTree=function(){var a=this._parentObject3DFacade;a&&this.threeObject.parent!==a.threeObject&&(a.threeObject.add(this.threeObject),a._addToThreeObjectTree())};b.prototype._queueRemoveChildObject3D=function(a){(this._removeChildIds||(this._removeChildIds=Object.create(null)))[a]=!0};b.prototype.destructor=
function(){this.notifyWorld("object3DRemoved");var a=this._parentObject3DFacade;a&&a._queueRemoveChildObject3D(this.threeObject.id);delete this.threeObject;c.prototype.destructor.call(this)};return b}(k.PointerEventTarget);["castShadow","receiveShadow","renderOrder","visible"].forEach(function(c){Object.defineProperty(n.prototype,c,{get:function(){return this.threeObject[c]},set:function(b){this.threeObject[c]=b}})});n.prototype.raycastSide=null;ha({position:{x:"x",y:"y",z:"z"},scale:{x:"scaleX",
y:"scaleY",z:"scaleZ"},rotation:{x:"rotateX",y:"rotateY",z:"rotateZ",order:"rotateOrder"},quaternion:{x:"quaternionX",y:"quaternionY",z:"quaternionZ",w:"quaternionW"}},function(c,b){ha(c,function(a,d){Object.defineProperty(n.prototype,a,{get:(new Function("return function "+a+"$get() {\n  return this.threeObject."+b+"."+d+"\n}"))(),set:(new Function("return function "+a+"$set(value) {\n  //let obj = this.threeObject."+b+"\n  if (this.threeObject."+b+"."+d+" !== value) {\n    this.threeObject."+b+
"."+d+" = value\n    if (!this._matrixChanged) {\n      this._matrixChanged = true\n    }\n  }\n}"))()})})});Object.defineProperty(n.prototype,"scale",{get:function(){return this.threeObject.scale.x},set:function(c){var b=this.threeObject.scale;if(c!==b.x||c!==b.y||c!==b.z)b.x=b.y=b.z=c,this._matrixChanged||(this._matrixChanged=!0)}});Object.defineProperty(n.prototype,"isObject3DFacade",{value:!0});L(n.prototype,{threeObject:null,_parentObject3DFacade:null,_removeChildIds:null,_matrixChanged:!0,_worldMatrixVersion:-1,
_worldMatrixVersionAfterLastUpdate:-1,_boundingSphereChanged:!1});k.Facade.defineEventProperty(n,"onBeforeRender","beforerender");k.Facade.defineEventProperty(n,"onAfterRender","afterrender");var ya=function(){},X=new e.Raycaster,Aa=new e.Vector2,U=new e.Vector3,W=new e.Matrix4,B=new e.Quaternion,V=new e.Vector3(0,1,0),za=0,ja=T(e.PerspectiveCamera,["fov","aspect","near","far"],["focus","filmGauge","filmOffset"]);L=T(e.OrthographicCamera,"left right top bottom near far".split(" "));var ka=function(c){function b(a){var d=
new e.Group;d.isRenderable=!1;c.call(this,a,d)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);return b.prototype.constructor=b}(n),Ja=function(c){function b(a){var d=new e.Object3D;d.isRenderable=!1;c.call(this,a,d);this.html=null;this.exact=!1;this.notifyWorld("addHtmlOverlay",this)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;b.prototype.destructor=function(){this.notifyWorld("removeHtmlOverlay",this);c.prototype.destructor.call(this)};return b}(n),
Y=function(c){function b(){c.apply(this,arguments)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={color:{configurable:!0},shadow:{configurable:!0}};a.color.set=function(a){this.threeObject.color.set(a)};a.color.get=function(){return this.threeObject.color.getHex()};a.shadow.get=function(){return this.threeObject.shadow};a.shadow.set=function(a){k.utils.assignDeep(this.threeObject.shadow,a)};Object.defineProperties(b.prototype,a);return b}(n);"intensity distance angle penumbra decay castShadow width height".split(" ").forEach(function(c){Object.defineProperty(Y.prototype,
c,{get:function(){return this.threeObject[c]},set:function(b){this.threeObject[c]=b}})});var la=z(e.AmbientLight),ma=z(e.DirectionalLight,e.DirectionalLightHelper),na=z(e.SpotLight,e.SpotLightHelper),oa=z(e.PointLight,e.PointLightHelper),pa=z(e.HemisphereLight,e.HemisphereLightHelper,{groundColor:{set:function(c){this.threeObject.groundColor.set(c)},get:function(){return this.threeObject.groundColor.getHex()}}}),Ka=z(e.RectAreaLight),Da="\ntroika_modelMatrix = mat4(\n  %0.x, %1.x, %2.x, 0.0,\n  %0.y, %1.y, %2.y, 0.0,\n  %0.z, %1.z, %2.z, 0.0,\n  %0.w, %1.w, %2.w, 1.0\n);\n".replace(/%/g,
"troika_modelMatrixRow"),aa=/\bmodelMatrix\b/g,ba=/\bmodelViewMatrix\b/g,ca=/\bnormalMatrix\b/g,qa=/\buniform\s+(int|float|vec[234])\s+$/,F=function(c,b,a){return qa.test(a.substr(0,b))?c:"troika_"+c},Ea=function(c,b,a){return qa.test(a.substr(0,b))?c:"troika_vary_"+c},Z=new WeakMap,M=k.utils.assign,N=function(c){function b(a){c.call(this,a);this._instanceables=Object.create(null);this._batchGeometryPool=new G;this._needsRebatch=!0;this.addEventListener("beforerender",this._setupBatchObjects.bind(this));
...
g){c=!0;break}if(c){a=this._batchObjectsByKey=Object.create(null);g=this._batchGeometryPool;for(var e in b){c=b[e];var h=c.threeObject,f=c.instancedThreeObject;if(f&&h.visible){var k=this._getBatchKey(f),A=f.material.instanceUniforms,n=a[k]||(a[k]=[]),m=(k=n[n.length-1])&&k.geometry;if(!m||128===K(m)){k=this._getBatchObject(f);m=k.geometry;for(var q=m._instanceAttrs.matrix,p=0;3>p;p++)q[p].version++;if(A)for(q=m._instanceAttrs.uniforms,p=A.length;p--;)q[A[p]].version++;n.push(k)}n=K(m);fa(m,n+1);
q=m._instanceAttrs.matrix;h=h.matrixWorld.elements;q[0].setXYZW(n,h[0],h[4],h[8],h[12]);q[1].setXYZW(n,h[1],h[5],h[9],h[13]);q[2].setXYZW(n,h[2],h[6],h[10],h[14]);if(A)for(q=m._instanceAttrs.uniforms,h=A.length;h--;){p=A[h];m=q[p];var r=c._instanceUniforms;p=r&&p in r?r[p]:ea(f.material,p);da(m,n,p)}c._instancingBatchObject=k;c._instancingBatchAttrOffset=n}else c._instancingBatchObject=c._instancingBatchAttrOffset=null}g.disposeUnused()}g=b=e=0;for(var t in a)for(c=a[t],d.children.push.apply(d.children,
c),b++,f=c.length;f--;)e++,g+=K(c[f].geometry);this.notifyWorld("statsUpdate",{"Instancing Batch Groups":b,"Instancing Batches":e,"Instanced Objects":g});this._needsRebatch=!1};b.prototype._onInstanceAdded=function(a){this._instanceables[a.$facadeId]=a;this._needsRebatch=!0};b.prototype._onInstanceRemoved=function(a){delete this._instanceables[a.$facadeId];this._needsRebatch=!0};b.prototype._onInstanceChanged=function(a){this._needsRebatch=!0};b.prototype._onInstanceMatrixChanged=function(a){if(!this._needsRebatch){var b=
a.instancedThreeObject,c=a._instancingBatchObject,l=a._instancingBatchAttrOffset;b&&c&&this._getBatchKey(b)===this._getBatchKey(c)?(b=c.geometry._instanceAttrs.matrix,a=a.threeObject.matrixWorld.elements,b[0].setXYZW(l,a[0],a[4],a[8],a[12]).version++,b[1].setXYZW(l,a[1],a[5],a[9],a[13]).version++,b[2].setXYZW(l,a[2],a[6],a[10],a[14]).version++):(a._instancingBatchObject=a._instancingBatchAttrOffset=null,this._needsRebatch=!0)}};b.prototype._onInstanceUniformChanged=function(a,b){if(!this._needsRebatch){var d=
a.instancedThreeObject,c=a._instancingBatchObject;d&&c&&this._getBatchKey(d)===this._getBatchKey(c)?(d=c.geometry._instanceAttrs.uniforms[b],da(d,a._instancingBatchAttrOffset,a._instanceUniforms[b]),d.version++):(a._instancingBatchObject=a._instancingBatchAttrOffset=null,this._needsRebatch=!0)}};b.prototype._getBatchKey=function(a){var b=this._batchKeysCache||(this._batchKeysCache=Object.create(null)),c=b&&b[a.id];if(!c){c=a.material;var l=c.instanceUniforms;c=a.geometry.id+"|"+c.id+"|"+(l?l.sort().join(","):
...
a.geometry,c=a.material;if(!b.isBufferGeometry)throw Error("Instanceable proto object must use a BufferGeometry");var l=this._getBatchKey(a),v=this._getInstanceUniformSizes(c);b=this._batchGeometryPool.borrow(l,b,v);fa(b,0);var J=Ba(c),h,f;c=Object.create(a,{geometry:{value:b},material:{value:J},visible:{value:!0},frustumCulled:{value:!1},customDepthMaterial:{get:function(){h||(h=J.getDepthMaterial(),h.isShaderMaterial=!0);return h}},customDistanceMaterial:{get:function(){f||(f=J.getDistanceMaterial(),
f.isShaderMaterial=!0,f.uniforms=M({viewMatrix:{value:new e.Matrix4}},f.uniforms));return f}},modelViewMatrix:{value:function(){var a=new e.Matrix4;a.multiplyMatrices=function(a,b){f&&(f.uniforms.viewMatrix.value.copy(a),f.uniformsNeedUpdate=!0);return e.Matrix4.prototype.multiplyMatrices.call(this,a,b)};return a}()}});c.$troikaBatchBaseObj=a;c.$troikaInstancingManager=this;return c};b.prototype._teardownBatchObjects=function(a,b,c){var d=this;this._batchGeometryPool.releaseAll();this._uniformSizesCache=
this._batchKeysCache=null;b.children=b.children.filter(function(a){return a.$troikaInstancingManager!==d})};b.prototype.destructor=function(){var a=this._batchGeometryPool;a.releaseAll();a.disposeUnused();c.prototype.destructor.call(this)};return b}(ka),G=function(){this._poolsByKey=Object.create(null)};G.prototype.borrow=function(c,b,a){var d=this._poolsByKey;c=d[c]||(d[c]={geometries:[],firstFree:0});d=c.geometries[c.firstFree++];if(!d){d=new e.InstancedBufferGeometry;M(d,b);d.attributes=M({},b.attributes);
b=d._instanceAttrs={matrix:[],uniforms:Object.create(null)};for(var g=0;3>g;g++){var l=new e.InstancedBufferAttribute(new Float32Array(512),4);l.setUsage?l.setUsage(35048):l.dynamic=!0;d.attributes["troika_modelMatrixRow"+g]=l;b.matrix[g]=l}for(var v in a)g=a[v],g=new e.InstancedBufferAttribute(new Float32Array(128*g),g),g.setUsage?g.setUsage(35048):g.dynamic=!0,d.attributes["troika_"+v]=g,b.uniforms[v]=g;c.geometries.push(d)}return d};G.prototype.releaseAll=function(){var c=this._poolsByKey;if(c)for(var b in c)c[b].firstFree=
0};G.prototype.disposeUnused=function(){var c=this._poolsByKey;if(c)for(var b in c){var a=c[b],d=a.firstFree;a=a.geometries;for(var g=d,l=a.length;g<l;g++){var e=a[g].attributes,f;for(f in e)e.hasOwnProperty(f)&&0!==f.indexOf("troika_")&&delete e[f];try{a[g].dispose()}catch(h){}a[g]._instanceAttrs=null}a.length=d}};var r=N.prototype;r._notifyWorldHandlers={instanceableAdded:r._onInstanceAdded,instanceableRemoved:r._onInstanceRemoved,instanceableChanged:r._onInstanceChanged,instanceableMatrixChanged:r._onInstanceMatrixChanged,
instanceableUniformChanged:r._onInstanceUniformChanged};var La={ambient:la,directional:ma,spot:na,point:oa,hemisphere:pa},Ma=[{distance:Infinity}],Na=new e.Sphere(void 0,Infinity),ra=[null],sa=function(c){function b(a){var b=new e.Scene;b.autoUpdate=!1;c.call(this,a,b)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={fog:{configurable:!0}};b.prototype.describeChildren=function(){var a={key:"instancingMgr",facade:N,children:this.objects},b=this.lights;b&&
(a=[a],Array.isArray(b)||(ra[0]=b,b=ra),b.forEach(function(b,d){var c=b.facade||La[b.type];if("function"===typeof c){var g=k.utils.assign({},b);delete g.type;g.key=b.key||"light"+d;g.facade=c;a.push(g)}}));return a};a.fog.set=function(a){var b=this._fogObj;if(a){var c="density"in a,d=c?e.FogExp2:e.Fog;b&&b instanceof d||(b=this._fogObj=new d);b.color.set(a.color);c?b.density=a.density:(b.near=a.near,b.far=a.far)}else b=this._fogObj=null;this.threeObject.fog=b};b.prototype.getBoundingSphere=function(){return Na};
b.prototype.raycast=function(a){return Ma};Object.defineProperties(b.prototype,a);return b}(n);r=k.utils.assign;var Oa=k.utils.forOwn,O=new e.Sphere,Pa=Math.sqrt(3),q=function(){this.root=null;this.keysToLeaves=Object.create(null)};q.prototype.putSpheres=function(c){var b=this;Oa(c,function(a,c){b.putSphere(c,a)})};q.prototype.putSphere=function(c,b){var a=b.center,d=b.radius;!b||isNaN(d)||isNaN(a.x)?console.warn("Invalid sphere",b):(a._roundedX=1E-8*Math.round(a.x/1E-8),a._roundedY=1E-8*Math.round(a.y/
1E-8),a._roundedZ=1E-8*Math.round(a.z/1E-8),this._putSphere(c,b))};q.prototype._putSphere=function(c,b){var a=this,d=b.center,g=this.root,l=d._roundedX,e=d._roundedY,f=d._roundedZ;if(c in this.keysToLeaves)return this._updateSphere(c,b);if(g)if(g.isLeaf){d=this.root;var h=g.dataX,k=g.dataY,n=g.dataZ;if(h===l&&k===e&&n===f)this._insertIntoOctant(c,b,g);else{var m=new p;g=m.cx=Math.round((h+l)/2);e=m.cy=Math.round((k+e)/2);f=m.cz=Math.round((n+f)/2);m.cr=Math.ceil(Math.max(Math.abs(g-h),Math.abs(e-
k),Math.abs(f-n))+1E-5);this.root=m;d.forEachLeafSphere(function(b,c){return a._insertIntoOctant(c,b,m)});this._insertIntoOctant(c,b,m)}}else this._expandToCoverPoint(l,e,f),this._insertIntoOctant(c,b,this.root);else d=new p,d.isLeaf=!0,d.addSphereData(c,b),this.root=d,this.keysToLeaves[c]=d};q.prototype._expandToCoverPoint=function(c,b,a){for(;!this.root.containsPoint(c,b,a);){var d=this.root,g=d.cx,l=d.cy,e=d.cz,f=d.cr,h=new p;h.maxRadius=d.maxRadius;h.sphereCount=d.sphereCount;h.leafCount=d.leafCount;
...
_instancedThreeObject:null});var Q=new e.BufferGeometry,Ta=new e.MeshBasicMaterial,R={basic:e.MeshBasicMaterial,depth:e.MeshDepthMaterial,distance:e.MeshDistanceMaterial,lambert:e.MeshLambertMaterial,matcap:e.MeshMatcapMaterial,normal:e.MeshNormalMaterial,phong:e.MeshPhongMaterial,physical:e.MeshPhysicalMaterial,standard:e.MeshStandardMaterial,toon:e.MeshToonMaterial},x=function(c){function b(a){c.call(this,a,new e.Mesh(Q,Ta));this.material="standard";this.autoDisposeMaterial=this.autoDisposeGeometry=
!1;this._dirtyMtlProps=null}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;b.prototype.afterUpdate=function(){var a=this.geometry,b=this.material,g=this.threeObject;(a||Q)!==g.geometry&&(this.autoDisposeGeometry&&g.geometry.dispose(),g.geometry=a||Q);b!==this._lastMtl&&(this._lastMtl=b,"string"===typeof b?b=new (R[b]||e.MeshStandardMaterial):b&&b.isMaterial||(b="function"===typeof b?new b:new e.MeshStandardMaterial),g.material!==b&&(this.autoDisposeMaterial&&
g.material.dispose(),g.material=b));if(a=this._dirtyMtlProps)g.material.setValues(a),this._dirtyMtlProps=null;c.prototype.afterUpdate.call(this)};b.prototype.destructor=function(){this.autoDisposeGeometry&&this.threeObject.geometry.dispose();this.autoDisposeMaterial&&this.threeObject.material.dispose();c.prototype.destructor.call(this)};return b}(n),Ua={type:1,id:1,uuid:1,version:1};Object.keys(R).forEach(function(c){var b=new R[c];c=function(a){b.hasOwnProperty(a)&&!Ua.hasOwnProperty(a)&&Object.defineProperty(x.prototype,
"material."+a,{enumerable:!0,configurable:!0,get:function(){var b=this._dirtyMtlProps;return b&&a in b?b[a]:this.threeObject.material[a]},set:function(b){(this._dirtyMtlProps||(this._dirtyMtlProps=Object.create(null)))[a]=b}})};for(var a in b)c(a)});var ua=k.utils.memoize(function(){return new e.BoxBufferGeometry(1,1,1,1,1)}),Va=function(c){function b(){c.apply(this,arguments)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={geometry:{configurable:!0},
width:{configurable:!0},height:{configurable:!0},depth:{configurable:!0}};a.geometry.get=function(){return ua()};a.width.set=function(a){this.scaleX=a};a.width.get=function(){return this.scaleX};a.height.set=function(a){this.scaleY=a};a.height.get=function(){return this.scaleY};a.depth.set=function(a){this.scaleZ=a};a.depth.get=function(){return this.scaleZ};Object.defineProperties(b.prototype,a);return b}(x),va=Object.create(null,[["low",32],["medium",64],["high",128]].reduce(function(c,b){var a=
b[1];c[b[0]]={get:k.utils.memoize(function(){return(new e.CircleBufferGeometry(1,a)).rotateX(-Math.PI/2)})};return c},{})),Wa=function(c){function b(a){c.call(this,a);this["material.side"]=this["material.shadowSide"]=e.DoubleSide}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={geometry:{configurable:!0},radius:{configurable:!0}};a.geometry.get=function(){return va[this.detail]||va.medium};a.radius.set=function(a){this.scaleX=this.scaleZ=a};a.radius.get=
function(){return this.scaleX};Object.defineProperties(b.prototype,a);return b}(x),Xa=function(c){function b(){c.apply(this,arguments)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={geometry:{configurable:!0},size:{configurable:!0}};a.geometry.get=function(){return ua()};a.size.set=function(a){this.scale=a};a.size.get=function(){return this.scale};Object.defineProperties(b.prototype,a);return b}(x),Ya=k.utils.memoize(function(){return(new e.PlaneBufferGeometry(1,
1,1,1)).rotateX(-Math.PI/2)}),Za=function(c){function b(a){c.call(this,a);this["material.side"]=this["material.shadowSide"]=e.DoubleSide}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={geometry:{configurable:!0},width:{configurable:!0},depth:{configurable:!0}};a.geometry.get=function(){return Ya()};a.width.set=function(a){this.scaleX=a};a.width.get=function(){return this.scaleX};a.depth.set=function(a){this.scaleZ=a};a.depth.get=function(){return this.scaleZ};
Object.defineProperties(b.prototype,a);return b}(x),wa=Object.create(null,[["low",16,12],["medium",32,24],["high",64,48]].reduce(function(c,b){var a=b[1],d=b[2];c[b[0]]={get:k.utils.memoize(function(){return new e.SphereBufferGeometry(1,a,d)})};return c},{})),$a=function(c){function b(){c.apply(this,arguments)}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;var a={geometry:{configurable:!0},radius:{configurable:!0}};a.geometry.get=function(){return wa[this.detail]||
wa.medium};a.radius.set=function(a){this.scale=a};a.radius.get=function(){return this.scale};Object.defineProperties(b.prototype,a);return b}(x),I=function(c){function b(a){var b=this;c.call(this,a);this._onCanvasRef=function(a){var c=b.context.onCanvasRef;c&&c(a);(c=b.props.onCanvasRef)&&c(a)}}c&&(b.__proto__=c);b.prototype=Object.create(c&&c.prototype);b.prototype.constructor=b;b.prototype.render=function(){var a=this.props,b=this.context;return u.createElement(c,k.utils.assign({},a,{onCanvasRef:this._onCanvasRef,
canvasStyle:a.canvasStyle||b.canvasStyle,worldFacade:a.worldFacade||b.worldFacade||H,worldProps:k.utils.assign({antialias:a.antialias,rendererClass:a.rendererClass,backgroundColor:a.backgroundColor,shadows:a.shadows,camera:a.camera,lights:a.lights,objects:a.objects,fog:a.fog,onBackgroundClick:a.onBackgroundClick},b.worldProps,a.worldProps)}),a.children)};return b}(k.ReactCanvasBase);I.displayName="Canvas3D";I.propTypes=k.utils.assignIf({backgroundColor:m.any,lights:m.array,camera:m.object,objects:m.oneOfType([m.array,
m.object]).isRequired,antialias:m.bool,onBackgroundClick:m.func,rendererClass:m.func},k.ReactCanvasBase.commonPropTypes);I.contextType=u.createContext({worldFacade:H,worldProps:{},onCanvasRef:null,canvasStyle:null});Object.defineProperty(f,"Facade",{enumerable:!0,get:function(){return k.Facade}});Object.defineProperty(f,"ListFacade",{enumerable:!0,get:function(){return k.ListFacade}});Object.defineProperty(f,"ParentFacade",{enumerable:!0,get:function(){return k.ParentFacade}});Object.defineProperty(f,
"createDerivedMaterial",{enumerable:!0,get:function(){return y.createDerivedMaterial}});f.AmbientLight3DFacade=la;f.BoxFacade=Va;f.Canvas3D=I;f.CircleFacade=Wa;f.CubeFacade=Xa;f.DirectionalLight3DFacade=ma;f.Group3DFacade=ka;f.HemisphereLight3DFacade=pa;f.HtmlOverlay3DFacade=Ja;f.Instanceable3DFacade=r;f.InstancingManager=N;f.MeshFacade=x;f.Object3DFacade=n;f.OrthographicCamera3DFacade=L;f.PerspectiveCamera3DFacade=ja;f.PlaneFacade=Za;f.PointLight3DFacade=oa;f.RectAreaLight3DFacade=Ka;f.Scene3DFacade=
sa;f.SphereFacade=$a;f.SpotLight3DFacade=na;f.World3DFacade=H;f.makeWorldTextureProvider=function(c){return function(b){function a(a){var c=this,d=new e.CanvasTexture;b.call(this,a,d);this.worldTexture=d;var f=this._refireAsInnerEvent.bind(this);Ra.forEach(function(a){function b(a){f(a);d&&d.call(this,a)}var d;c[a]=b;Object.defineProperty(c,a,{set:function(a){d=a},get:function(){return b}})})}b&&(a.__proto__=b);a.prototype=Object.create(b&&b.prototype);a.prototype.constructor=a;a.prototype.afterUpdate=
function(){var a=this,c=this._worldFacade,e=this.textureWorld;c&&e&&c instanceof e.facade||(c&&(c.onAfterRender=null,c.destructor()),e&&(this.worldTexture.dispose(),c=document.createElement("canvas"),c.width=c.height=2,this.worldTexture.image=c,c=this._worldFacade=new e.facade(c),c.onAfterRender=function(){a.worldTexture.needsUpdate=!0;a.notifyWorld("needsRender")}));c&&(c.renderingScheduler=this._getOuterWorld().renderingScheduler,k.utils.assign(c,e),c.afterUpdate());b.prototype.afterUpdate.call(this)};
a.prototype._refireAsInnerEvent=function(a){var b=this._worldFacade;if(b){var c=a.intersection&&a.intersection.uv,d=c?Math.round(c.x*b.width):-1;b=c?Math.round((1-c.y)*b.height):-1;a=a.nativeEvent||a;c=document.createEvent("MouseEvents");c.initMouseEvent(a.type,!0,!0,window,a.detail,d,b,d,b,a.ctrlKey,a.altKey,a.shiftKey,a.metaKey,a.button,null);this.worldTexture.image.dispatchEvent(c)}};a.prototype._getOuterWorld=function(){for(var a=this;a&&!a.isWorld;)a=a.parent;return a};a.prototype.destructor=
function(){var a=this._worldFacade;a&&(a.onAfterRender=null,a.destructor());this.worldTexture.dispose();b.prototype.destructor.call(this)};return a}(c)};Object.defineProperty(f,"__esModule",{value:!0})})
