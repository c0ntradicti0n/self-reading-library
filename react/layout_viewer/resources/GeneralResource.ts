    ...
    constructor(
        ...
        if (add_id) {
            ...
            if (typeof window !== "undefined") {
                ...
                console.log(localStorage, route, localStorage.getItem(route), new window.URLSearchParams(window.location.search).get("id"));

                // @ts-ignore
                this.id = "/" + id + "_" + cyrb53(new window.URLSearchParams(window.location.search).get("id"));
            }
        }
    }
