...
class TrueFormatUpmarkerPdf2HTMLEX (TrueFormatUpmarker):
    ...
    def generate_data_for_file(self, html_read_from):
        ...
        self.assign_labels_from_div_content(features=features)
    ...
    FeatureKinds = namedtuple("FeatureKinds", ["coarse_grained_pdfs", "coarse_grained_field", "number_of_columns"])
    ...
    def analyse_point_density_frequence(self, page_features, debug=True, axe_len_X=100, axe_len_Y=100) -> FeatureKinds:
        ...
        return self.FeatureKinds(coarse_grained_pdfs, coarse_grained_field, number_of_columns)
