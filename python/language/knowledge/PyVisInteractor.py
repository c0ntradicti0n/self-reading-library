...
from _common import default_options_

app = dash.Dash(
    __name__,
    external_stylesheets=[dashvis.stylesheets.VIS_NETWORK_STYLESHEET],
...
""",
                ...
                html.Div(
                    [
                        ...
                        dcc.Input(
                            id="hubsize", value=1, type="number", placeholder="Hubsize"
                        ),
                    ]
                ),
                html.Div(
                    [
                        ...
                        html.Button(
                            "Cluster by connection", id="clusterByConnection_button"
                        ),
