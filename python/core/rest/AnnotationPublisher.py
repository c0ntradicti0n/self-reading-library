...
if __name__ == "__main__":
    test_annotation = [
        ...
        ["arise", "B-CONTRAST"],
        ["as", "I-CONTRAST"],
        ["nontrivial", "I-CONTRAST"],
        ["solutions", "I-CONTRAST"],
        ["in", "I-CONTRAST"],
        ["field", "I-CONTRAST"],
        ["theories", "I-CONTRAST"],
        ["with", "I-CONTRAST"],
        ...
        ["the", "I-CONTRAST"],
        ["absolute", "I-CONTRAST"],
        ["conservation", "I-CONTRAST"],
        ["of", "I-CONTRAST"],
        ["topological", "I-CONTRAST"],
        ["charge", "I-CONTRAST"],
        [",", "I-CONTRAST"],
        ["or", "I-CONTRAST"],
        ["winding", "I-CONTRAST"],
        ...
        ["become", "I-CONTRAST"],
        ["so", "I-CONTRAST"],
        ["important", "I-CONTRAST"],
        ["in", "I-CONTRAST"],
        ["the", "I-CONTRAST"],
        ["description", "I-CONTRAST"],
        ["of", "I-CONTRAST"],
        ["phenomena", "I-CONTRAST"],
        ["like", "I-CONTRAST"],
        [",", "I-CONTRAST"],
        ["optical", "I-CONTRAST"],
        ["self-focusing", "I-CONTRAST"],
        [",", "I-CONTRAST"],
        ["magnetic", "I-CONTRAST"],
        ["flux", "I-CONTRAST"],
        ["in", "I-CONTRAST"],
        ["Josephson", "I-CONTRAST"],
        ["junctions[2]", "I-CONTRAST"],
        ["or", "I-CONTRAST"],
        ["even", "I-CONTRAST"],
        ["the", "I-CONTRAST"],
        ["very", "I-CONTRAST"],
        ["existence", "I-CONTRAST"],
        ["of", "I-CONTRAST"],
        ["stable", "I-CONTRAST"],
        ["elementary", "I-CONTRAST"],
        ["particles", "I-CONTRAST"],
        [",", "I-CONTRAST"],
        ["such", "I-CONTRAST"],
        ["as", "I-CONTRAST"],
        ["the", "I-CONTRAST"],
